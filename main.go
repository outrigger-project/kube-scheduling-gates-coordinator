...
import (
	...
	webhook2 "github.com/outrigger-project/kube-scheduling-gates-coordinator/internal/webhook"
	...
	"github.com/outrigger-project/kube-scheduling-gates-coordinator/internal/controller"
...
func init() {
	...
	utilruntime.Must(ksgcv1beta1.AddToScheme(scheme))
...
func registerWebhooks(mgr manager.Manager) error {
	...
	handler := webhook2.NewPodMutator(mgr.GetClient(), clientset, mgr.GetScheme(),
		mgr.GetEventRecorderFor(utils.SchedulingGatesOrderingName), pool)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "078d2895.outrigger.sh",
	...
	if err = (&controller.SchedulingGatesOrderingReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SchedulingGatesOrdering")
		os.Exit(1)
	}
